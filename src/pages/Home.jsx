    ...
    <>
      ...
      <section className="relative h-screen w-full flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 max-w-3xl">
          <h1 className="text-2xl sm:text-4xl md:text-6xl font-bold leading-tight tracking-tight drop-shadow-lg">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-14 items-center">
            <div className="space-y-6">
              ...
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-xl">
                Ridhi Sidhi Boutique Raman mein hum traditional Punjabi style se lekar latest trending designer suits tak, har design ko pyaar aur precision ke saath craft karte hain — bilkul aapki pasand ke mutabik.
              </p>
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-xl">
